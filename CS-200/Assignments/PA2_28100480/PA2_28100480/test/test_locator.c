...
int testInitialize(Locator* map, char* origin){
    int marks = 0;
    int valid = 1;
...
int testMake(Locator* map, char* identifiers[], void* addresses[]){
    int marks = 0;
...
int testResize(Locator** map, char* identifiers[], void* addresses[]){
    int marks = 0;
...
int testRemove(Locator* map, char* identifiers[], char* identifiers_test[], void* addresses_test[]){
    int marks = 0;
...
int testGet(Locator* map, char* identifiers[], void* addresses[]){
    int marks = 0;
